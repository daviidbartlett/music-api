module.exports = [
  ...
  },
  {
    ...
    genres: ['Pop'],
    lyrics:
      'Vi kommer inte någonstans om du inte försöker också\nÄlskling bara andas\nDu måste försöka också\nOm du blir frustrerad slåss då\nBättre det än inget alls\nAlls\nAlls\nTills den dag då allting vänder\nStormen, lyckan, nån annans händer\nMåste veta hur du känner\nKänner\nKänner\nOm du kunde säga mig, nu innan allting är förlorat\nKan du säga mig\nåh säga mig vad som helst\nOm du kunde säga mig\nNu innan allting är förlorat\nKan du säga mig\nåh säga mig vad som helst\nDu vet vad jag menar\nDet har vart såhär för länge\nSnälla sluta vela\nDu har vart sånhär för länge\nSom att du vill inte lämna sängen\nOch ändå inte ligga kvar\nKvar\nEnda som jag nu behöver\nÄr att denna skit går över\nVitt vin dämpar, rött vin söver\nSöver\nSöver\nOm du kunde säga mig\nNu innan allting är förlorat\nKan du säga mig\nÅh säga mig vad som helst\nOm du kunde säga mig\nNu innan allting är förlorat\nKan du säga mig\nÅh säga mig vad som helst\nJag kan inte göra mer\nNär du bara står still\nVi kan lika gärna lägga ner\nOm det är det du vill\nOm du kunde säga mig\nNu innan allting är förlorat\nKan du säga mig\nÅh säga mig vad som helst\nOm du kunde säga mig\nNu innan allting är förlorat\nKan du säga mig\nÅh säga mig vad som helst\nSå om du kunde säga mig\nNu innan allting är förlorat\nKan du säga mig\nÅh säga mig vad som helst\nOm du kunde säga mig\nNu innan allting är förlorat\nKan du säga mig\nÅh säga mig vad som helst',
    release_date: 2017,
    playlist: 'Coffee Shop',
  },
  {
  ...
  },
  {
    ...
    artist: 'Donny Osmond',
    genres: ['Musicals', "Children's Music"],
    lyrics:
